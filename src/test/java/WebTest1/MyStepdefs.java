...
public class MyStepdefs {
    ...
    public void userClicksOnLinkFromTopMenu(String category1) {
        homePage.clickonCategoryLinks(category1);
    }
    ...
    @Then("user should be able to see Facebook page opened up in another window tab")
    public void userShouldBeAbleToSeeFacebookPageOpenedUpInAnotherWindowTab() {
    }
}
